...
NOTE: Micronaut MCP binds parameters with type api:mcp.server.context.MicronautMcpTransportContext[] or `io.modelcontextprotocol.spec.McpSchema.ReadResourceRequest` automatically.
