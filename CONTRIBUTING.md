...
Sign the [Contributor License Agreement (CLA)](https://cla-assistant.io/micronaut-projects/micronaut-mcp). This is required before any of your code or pull-requests are accepted.
...
Micronaut mcp currently requires JDK 17.

## IDE Setup

Micronaut mcp can be imported into IntelliJ IDEA by opening the `build.gradle` file.

## Docker Setup

Micronaut mcp tests currently require Docker to be installed.
