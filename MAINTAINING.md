...
We have a [template repo](https://github.com/micronaut-projects/micronaut-mcp) that we use as the single
...
[Release GitHub Action workflow](https://github.com/micronaut-projects/micronaut-mcp/blob/master/.github/workflows/release.yml)
