...
public final class JsonRpcMessages {
    ...
    public static final String FEN = "r1bqk2r/ppp2ppp/2n5/1BbpP3/3Nn3/8/PPP2PPP/RNBQK2R w KQkq - 1 8";
    ...
    public static final String EXPECTED_TOOLS_CALL = """
        {"jsonrpc":"2.0","id":4,"result":{"content":[{"type":"text","text":"+0.12"}],"isError":false}}""";

    public static final String EXPECTED_TOOLS_LIST_WITH_INPUT_SCHEMA = """
    ...
    public static final String EXPECTED_TOOLS_CALL_WITH_OUTPUT_SCHEMA = """
        {"jsonrpc":"2.0","id":4,"result":{"content":[{"type":"text","text":"{\\"fen\\":\\"r1bqk2r/ppp2ppp/2n5/1BbpP3/3Nn3/8/PPP2PPP/RNBQK2R w KQkq - 1 8\\",\\"evaluation\\":\\"+0.12\\"}"}],"isError":false,"structuredContent":{"evaluation":"+0.12","fen":"r1bqk2r/ppp2ppp/2n5/1BbpP3/3Nn3/8/PPP2PPP/RNBQK2R w KQkq - 1 8"}}}""";

    public static final String EXPECTED_HELLO_WORLD_TOOL_ANNOTATIONS = """
        ,"annotations":{"title":"Hello World","readOnlyHint":true,"destructiveHint":false,"idempotentHint":true,"openWorldHint":false,"returnDirect":true}}]}}""";

    public static final String SEARCH_TOOL_CALL = """
        {"jsonrpc":"2.0","id":20,"method":"tools/call","params":{"name":"search","arguments":{"query":"security"}}}""";

    public static final String EXPECTED_SEARCH_TOOL_CALL = """
    ...
    public static final String FETCH_TOOL_CALL = """
        {"jsonrpc":"2.0","id":20,"method":"tools/call","params":{"name":"fetch","arguments":{"id":"micronaut-security"}}}""";

    public static final String EXPECTED_FETCH_TOOL_CALL = """
    ...
    public static final String EXPECTED_PROMPTS_LIST = """
    ...
    public static final String EXPECTED_PROMPTS_GET = """
        {"jsonrpc":"2.0","id":0,"result":{"messages":[{"role":"assistant","content":{"type":"text","text":"You generate chess statistics for sergio ...."}}]}}""";

    public static final String EXPECTED_PROMPTS_GET_FACTORY = """
        {"jsonrpc":"2.0","id":0,"result":{"description":"Chess statistics","messages":[{"role":"assistant","content":{"type":"text","text":"You generate chess statistics for sergio ...."}}]}}""";
    ...
    public static final String RESOURCES_READ_ROUND_2 = """
        {"jsonrpc":"2.0","id":9,"method":"resources/read","params":{"_meta":{"progressToken":9},"uri":"pgn://round/2"}}""";

    public static final String RESOURCES_READ_ROUND_99 = """
        {"jsonrpc":"2.0","id":9,"method":"resources/read","params":{"_meta":{"progressToken":9},"uri":"pgn://round/99"}}""";

    public static final String EXPECTED_RESOURCES_LIST_HELLO = """
        {"jsonrpc":"2.0","id":2,"result":{"resources":[{"uri":"example://hello","name":"hello","title":"Hello","description":"Hello text","mimeType":"text/plain"}]}}""";

    public static final String EXPECTED_RESOURCES_READ_HELLO = """
        {"jsonrpc":"2.0","id":9,"result":{"contents":[{"uri":"example://hello","mimeType":"text/plain","text":"Hello World"}]}}""";

    public static final String EXPECTED_RESOURCES_LIST_PGN = """
    ...
    public static final String EXPECTED_RESOURCES_TEMPLATES_LIST = """
    ...
    public static final String EXPECTED_PROMPT_COMPLETION = """
        {"jsonrpc":"2.0","id":1,"result":{"completion":{"values":["python","pytorch","pyside"],"total":3,"hasMore":false}}}""";
    ...
    public static final String EXPECTED_RESOURCE_COMPLETION = """
        {"jsonrpc":"2.0","id":1,"result":{"completion":{"values":["report.pdf"],"total":1,"hasMore":false}}}""";

    public static final String RESOURCES_READ_REPORT = """
        {"jsonrpc":"2.0","id":9,"method":"resources/read","params":{"uri":"file:///home/user/documents/report.pdf"}}""";

    public static final String EXPECTED_RESOURCES_READ_REPORT = """
        {"jsonrpc":"2.0","id":9,"result":{"contents":[{"uri":"file:///home/user/documents/report.pdf","mimeType":"text/plain","text":"Report PDF"}]}}""";
