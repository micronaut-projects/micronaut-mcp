            ...
            McpServer.StatelessAsyncSpecification spec = McpServer.async(transport)
                ...
                .tools(McpStatelessServerFeatures.AsyncToolSpecification.builder()
                    .callHandler(new BiFunction<McpTransportContext, CallToolRequest, Mono<CallToolResult>>() {
                        @Override
                        public Mono<CallToolResult> apply(McpTransportContext mcpTransportContext, CallToolRequest callToolRequest) {
                ...
                .prompts(new McpStatelessServerFeatures.AsyncPromptSpecification(new McpSchema.Prompt("code_review",
                    "Request Code Review",
                    ...
                    (mcpTransportContext, getPromptRequest) ->
                        Mono.just(new McpSchema.GetPromptResult("Code review prompt",
                            List.of(new McpSchema.PromptMessage(USER, new McpSchema.TextContent("Please review this Python code")))))))
                .resources(new McpStatelessServerFeatures.AsyncResourceSpecification(McpSchema.Resource.builder()
                    ...
                    Mono.just(new McpSchema.ReadResourceResult(List.of(new McpSchema.TextResourceContents("file:///project/src/main.rs", "text/x-rust", "fn main() {\n    println!(\"Hello world!\");\n}"))))))
