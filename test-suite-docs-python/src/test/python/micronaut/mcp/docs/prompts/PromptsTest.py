...
from micronaut.mcp.docs.JsonRpcMessages import EXPECTED_PROMPTS_GET, EXPECTED_PROMPTS_LIST, PROMPTS_GET, PROMPTS_LIST
...
class PromptsTest:
    ...
    def prompts_get(self) -> None:
        ...
        assert json.loads(result) == json.loads(EXPECTED_PROMPTS_GET)
