...
from micronaut.mcp.docs.JsonRpcMessages import EXPECTED_TOOLS_CALL, EXPECTED_TOOLS_LIST_SNAKE_CASE, TOOLS_CALL_SNAKE_CASE, TOOLS_LIST
...
class ToolsTest:
    ...
    def tools_list(self) -> None:
        ...
        assert json.loads(result) == json.loads(EXPECTED_TOOLS_LIST_SNAKE_CASE)
