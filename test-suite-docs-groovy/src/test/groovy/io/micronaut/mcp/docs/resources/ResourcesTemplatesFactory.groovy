...
import static io.micronaut.mcp.docs.resources.ResourcesFactory.PGN_MIME_TYPE
import static io.micronaut.mcp.docs.resources.ResourcesFactory.readResourceResult
...
class ResourcesTemplatesFactory {
    ...
    McpStatelessServerFeatures.SyncResourceTemplateSpecification pgnResourceTemplateSpecification() {
        ...
        new McpStatelessServerFeatures.SyncResourceTemplateSpecification(resourceTemplate,
