...
import static io.micronaut.mcp.docs.JsonRpcMessages.EXPECTED_PROMPTS_GET_FACTORY
...
@Property(name = "spec.name", value = "PromptsFactorySpec")
@MicronautTest
class PromptsFactorySpec extends Specification {
    ...
    void "prompts get"() {
        ...
        then:
        JSONAssert.assertEquals(EXPECTED_PROMPTS_GET_FACTORY, result, true)
    }
}
