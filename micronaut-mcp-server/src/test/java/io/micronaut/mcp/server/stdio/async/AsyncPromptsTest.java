...
@Property(name = "spec.name", value = "AsyncPromptsTest")
@MicronautTest
class AsyncPromptsTest {
    @Inject
    ...
    @Requires(property = "spec.name", value = "AsyncPromptsTest")
    @Factory
    static class AsyncPromptsFactory {
        @Singleton
        McpServerFeatures.AsyncPromptSpecification prompt() {
