...
final class McpStatelessSyncServerFactory extends AbstractMcpServerFactory<McpServer.StatelessSyncSpecification, McpStatelessServerTransport,
    ...
    @Override
    protected List<McpStatelessServerFeatures.SyncCompletionSpecification> getCompletions(CompletionRegistry completionRegistry) {
        return completionRegistry.getStatelessSyncSpecs();
    }
