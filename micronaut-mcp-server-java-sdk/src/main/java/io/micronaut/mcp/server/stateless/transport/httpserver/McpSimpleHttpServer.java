 ...
 */
package io.micronaut.mcp.server.stateless.transport.httpserver;
...
public class McpSimpleHttpServer implements McpHttpServer {
     ...
     * @throws IOException IO Exception while invoking {@link HttpServer#create(InetSocketAddress, int)}
     */
     ...
     * @throws IOException IO Exception while invoking {@link HttpServer#create(InetSocketAddress, int)}
     */
    public McpSimpleHttpServer(HttpServerMcpStatelessServerTransport<HttpExchange> transport,
                               McpJsonMapper jsonMapper) throws IOException {
     ...
     * @throws IOException IO Exception while invoking {@link HttpServer#create(InetSocketAddress, int)}
     */
    public McpSimpleHttpServer(InetSocketAddress inetSocketAddress,
                               String endpoint,
