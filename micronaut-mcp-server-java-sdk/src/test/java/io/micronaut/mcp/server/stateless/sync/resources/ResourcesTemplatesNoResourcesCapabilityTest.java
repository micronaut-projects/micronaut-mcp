...
@MicronautTest
class ResourcesTemplatesNoResourcesCapabilityTest extends NoCapabilityTest {
    @Override
    @Test
    ...
    protected String getExpectedResponse() {
        return """
        {"jsonrpc":"2.0","id":1,"error":{"code":-32601,"message":"Method not found: resources/templates/list"}}""";
    }
}
