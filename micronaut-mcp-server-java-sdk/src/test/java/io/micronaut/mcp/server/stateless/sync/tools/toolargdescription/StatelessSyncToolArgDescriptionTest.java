...
class StatelessSyncToolArgDescriptionTest {
    ...
    private static final String EXPECTED_TOOLS_LIST_WITH_TOOLARG_DESCRIPTION = """
        {"jsonrpc":"2.0","id":3,"result":{"tools":[{"name":"fenEvaluation","description":"Evaluate a chess position using a FEN string.","inputSchema":{"type":"object","properties":{"fen":{"description":"A Chess position in Forsyth–Edwards Notation","type":"string"}},"required":["fen"]}}]}}""";
