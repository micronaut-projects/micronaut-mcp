...
@Property(name = "spec.name", value = "McpTransportContextBindingTest")
@Property(name = "micronaut.server.locale-resolution.fixed", value = "es_ES")
@MicronautTest
class McpTransportContextToolBindingTest {
  ...
  "result": {
    ...
    @Requires(property = "spec.name", value = "McpTransportContextBindingTest")
    @Singleton
    static class Tools {
        @Tool
        String locale(McpTransportContext ctx) {
            Object obj =  ctx.get(HttpHeaders.ACCEPT_LANGUAGE);
        ...
        @Tool
        String translator(String query, McpTransportContext ctx) {
            Object obj =  ctx.get(HttpHeaders.ACCEPT_LANGUAGE);
            if (obj instanceof Locale locale) {
        ...
        @Tool
        String translatorPojo(McpTransportContext ctx, SearchRequest request) {
            Object obj =  ctx.get(HttpHeaders.ACCEPT_LANGUAGE);
            if (obj instanceof Locale locale) {
